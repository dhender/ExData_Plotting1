...
# Plot data
par(mfrow = c(2, 2))
plot(txtfile$DateTime, txtfile$Global_active_power, xlab = '', ylab = 'Global Active Power (kilowatt)', type = 'l')
plot(txtfile$DateTime, txtfile$Voltage, xlab = 'datetime', ylab = 'Voltage', type = 'l')
...
plot(txtfile$DateTime, txtfile$Global_reactive_power, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l')
# close device
dev.off()